...
const ContactPage = () => {
  const handleClick = () => {
    ...
    const body = 'Hi Arshad, I came across your portfolio and wanted to connect.';
    window.location.href = `mailto:${email}?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
  };

  const socialLinks = [
    { icon: <FaGithub size={20} />, href: 'https://github.com/Arshad333H' },
    { icon: <FaLinkedin size={20} />, href: 'https://www.linkedin.com/in/shaik-mohammed-arshad-shareef-439698245/' },
    { icon: <FaTwitter size={20} />, href: 'https://x.com/Arshad333_s' },
    { icon: <FaInstagram size={20} />, href: 'https://www.instagram.com/a_rshad333.s' },
    { icon: <FaEnvelope size={20} />, href: 'mailto:skmohammedarshad333@gmail.com' },
  ];

  return (
    <div className="mt-20 md:mt-0 md:min-h-screen flex items-center justify-center px-4 bg-white dark:bg-gray-900">
      <div className="max-w-md w-full p-6 bg-gray-50 dark:bg-gray-800 rounded-2xl shadow-lg space-y-8">
        ...
        <div className="flex items-center gap-3 bg-white dark:bg-gray-700 p-3 rounded-lg shadow">
          ...
          <span className="text-gray-800 dark:text-white">Get In Touch (Mail Me)</span>
        </div>
        ...
        <div className="pt-4 border-t border-gray-300 dark:border-gray-600">
          <h2 className="text-sm text-center text-gray-500 dark:text-gray-400 mb-2">Follow me</h2>
